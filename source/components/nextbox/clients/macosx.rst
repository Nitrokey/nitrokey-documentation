...
1. Download the Nextcloud client application: https://nextcloud.com/install/
   ...
   .. figure:: /components/nextbox/images/mac_app/nextc-download.png
      :alt: imgsp1
      :scale: 30 %
...
2. After installation, click "Log in to your Nextcloud". Afterwards please provide your Nextcloud's domain.
   ...
   .. figure:: /components/nextbox/images/mac_app/nextc-connect.png
      :alt: imgsp1
      :scale: 30 %
...
3. Provide your username and password and click "Log in".
   ...
   .. figure:: /components/nextbox/images/mac_app/nextc-login.png
      :alt: imgsp1
      :scale: 30 %
   ...
   .. figure:: /components/nextbox/images/mac_app/nextc-menu-bar-icon.png
      :alt: imgsp1
      :scale: 30 %
   ...
   .. figure:: /components/nextbox/images/mac_app/nextc-finder.png
      :alt: imgsp1
      :scale: 30 %
