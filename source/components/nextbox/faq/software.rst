...
.. faq::
   What kind of public key is expected for SSH access?
...
.. faq::
   Can the operating system be extended or configured manually?
...
.. faq::
   Where can I see a changelog for the NextBox versions?
...
.. faq::
   Is the NextBox running a 32bit or 64bit operating system?

  The used OS is a 64bit system. The ``arch`` output: `aarch64`.

.. faq::
   Which users and default passwords are created by default on the NextBox's operating system?
