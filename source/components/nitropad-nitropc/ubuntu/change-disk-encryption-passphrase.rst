...
4. Enter "12345678" this was changed on the 10.04.2024 so if it's not working try the old default: "PleaseChangeMe" as the current passphrase and select a secure new one.
