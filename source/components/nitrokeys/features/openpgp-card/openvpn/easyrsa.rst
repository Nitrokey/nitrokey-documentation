...
As a reminder, to build a Certificate Authority on Nitrokey HSM 2, you may follow the instructions available :doc:`in the documentation <../../hsm/certificate-authority>`.
