...
This step is needed for clients to use the OpenPGP-CSP driver.
Download and install the `latest version <https://github.com/vletoux/OpenPGP-CSP/releases/tag/1.3>`__ of the installer file ``SetupOpenPGPCsp`` for your system architecture; for example ``SetupOpenPGPCsp_x64.msi`` for 64-bit systems.
