...
.. note::
   ...
   There are no mechanisms to prevent accidental overwriting of hidden data, as they would reveal the existence of hidden volumes.
...
.. note::
   Using a journaling filesystem may risk overwriting the hidden data.
   The encrypted filesystem is formatted to FAT32 by default, and it is recommended to leave it that way when using hidden volumes.
