...
In order to use FIDO2 with your NitroPhone we recommend using `Authnkey  <https://f-droid.org/en/packages/pl.lebihan.authnkey/>`_ which is an open source app that permits to use FIDO2 without the Google Play Services.
