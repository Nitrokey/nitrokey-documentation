...
If you are in doubt which one to choose, you should use OpenPGP. While this page describes the usage of OpenPGP, S/MIME is described `here <https://docs.nitrokey.com/pro/smime.html>`__.
...
-  `Generate keys on
   Nitrokey <https://docs.nitrokey.com/pro/openpgp-keygen-gpa.html>`__
...
-  `Generate keys on Nitrokey with different algorithm or key
   size <https://docs.nitrokey.com/pro/openpgp-keygen-on-device.html>`__
...
-  `Generate keys
   locally <https://docs.nitrokey.com/pro/openpgp-keygen-backup.html>`__
...
-  for using `OpenPGP encryption with
   Thunderbird <https://docs.nitrokey.com/pro/openpgp-thunderbird.html>`__

-  for using `OpenPGP encryption with
   Outlook <https://docs.nitrokey.com/pro/windows/openpgp-outlook.html>`__
